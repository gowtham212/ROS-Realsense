...
echo_and_run cd "/home/ialab/obdet_ws/src/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ialab/obdet_ws/src/vision_opencv/cv_bridge/setup.py" \
     \
    build --build-base "/home/ialab/obdet_ws/build/vision_opencv/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
