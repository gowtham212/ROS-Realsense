...
echo_and_run cd "/home/bit/catkin_ws1/src/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/bit/catkin_ws1/src/vision_opencv/cv_bridge/setup.py" \
     \
    build --build-base "/home/bit/catkin_ws1/build/vision_opencv/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
